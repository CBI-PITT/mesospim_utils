...
LOCATION_PYIMARISWRITER_ENV = general.get('location_pyimariswriter_environment', ENV_PYTHON_LOC)
...
LOCATION_PYIMARISWRITER_ENV = Path(LOCATION_PYIMARISWRITER_ENV)
